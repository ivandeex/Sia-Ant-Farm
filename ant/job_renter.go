...
func downloadFile(r *RenterJob, fileToDownload modules.FileInfo, destPath string) error {
	...
	log.Printf("[INFO] [renter] [%v] Downloading siaFile to local file:\n\t%v\n\t%v", r.staticJR.staticSiaDirectory, siaPath, destPath)
	...
	log.Printf("[INFO] [renter] [%v] Successfully downloaded siaFile to local file:\n\t%v\n\t%v\n", r.staticJR.staticSiaDirectory, siaPath, destPath)
	return nil
}
