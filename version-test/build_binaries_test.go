...
func TestBuildBinaries(t *testing.T) {
	...
	// still passes.
	expectedReleases := []string{"v1.3.7", "v1.4.0", "v1.4.1", "v1.4.1.1", "v1.4.1.2", "v1.4.2.0", "v1.4.3", "v1.4.4-antfarm", "v1.4.5-antfarm", "v1.4.6-antfarm", "v1.4.7-antfarm", "v1.4.8-antfarm", "v1.4.10-antfarm", "v1.4.11-antfarm", "v1.5.0"}
